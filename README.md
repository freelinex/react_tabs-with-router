...
5. Redirect from `/home` to `/` using the [Navigate](https://reactrouter.com/en/main/components/navigate) component;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://freelinex.github.io/react_tabs-with-router/) and add it to the PR description.
